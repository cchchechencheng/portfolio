# Study Buddy - Content Manifest (内容清单)
...
## 0. Hero Section (头图区域)
**Background Image**: Image: [sb-hero-image.jpg]
**Main Title (H1)**: Text: [Study Buddy]
**Subtitle**: Text: [Das Schulbuch von morgen – schon heute nutzbar.]
**Intro Paragraph**: Text: [Mehr als ein E‑Book: ein KI‑gestütztes, inklusives, immersives und interaktives Lernsystem.]
**Hashtags**:
- Tag 1: Text: [UX Design]
- Tag 2: Text: [UI Design]
- Tag 3: Text: [Interaction Design]

---

## 1. Overview (项目概览)
**Section Title**: Text: [Projekt-überblick]
**Main Description**:
Text: [
...
## 2. Problem (用户痛点)
**Section Title**: Text: [Zielgruppe & Problem]
**Main Content**:
Text: [
...
## 3. Goal (设计目标)
**Section Title**: Text: [Zielsetzung]
**Main Content**:
Text: [
Lernen  
personalisieren  
...
Digitale Stärken nutzen  
KI ersetzt starre Seiten durch interaktive Lernprozesse.
]
**Assets Included**:
- Image: [digitale-nutzen.png] 
- Image: [lernen-personalisieren.png] 
- Image: [wissen-vernetzen.png] 

---

## 4. Research (调研分析)
**Section Title**: Text: [Recherche]
**Main Content**:
Text: [
...
## 5. Konzept  &  Systemaufbau
**Section Title**: Text: [Konzept  &  Systemaufbau]
**Main Content**:
**Assets Included**:
- Image: [systemaufbau.png]
Text: [
...
## 6. Wireframes  &  Komponenten
**Section Title**: Text: [Wireframes  &  Komponenten]
**Main Content**:
Text: [
...
- Image: [components5.png]

---

## 7. Key Screens
**Section Title**: Text: [Key Screens]
**Main Content**:
Text: [
- Chatbot: Chat mit der KI  
...
- Image: [workbook2.png]
Text: [
- Wissensnetz: Management & Recherche  
...
**Assets Included**:
- Image: [datenbank1.png]
- Image: [datenbank2.png]
...
- Datenschutzkonzepte für schulische Umgebungen
